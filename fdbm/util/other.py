...
def from_flattened_numpy(x_flat, shape):
    """Form a torch tensor with the given `shape` from a flattened numpy array `x_flat`."""
    return torch.from_numpy(x_flat.reshape(shape))