...
@BackboneRegistry.register("ncsnpp_v2_5M")
class NCSNpp_v2_5M(NCSNpp_v2):
...
@BackboneRegistry.register("ncsnpp_v2_16M")
class NCSNpp_v2_16M(NCSNpp_v2):
    def __init__(self, **kwargs):
        super().__init__(
            nf=64,
            ch_mult=(1, 1, 2, 2, 2, 2, 2),
    ...
    # def forward(self, x, y, t):
    #     crm = super().forward(x, y, t)
    #     return crm * y


@BackboneRegistry.register("ncsnpp_v2_37M")
class NCSNpp_v2_37M(NCSNpp_v2):
    def __init__(self, **kwargs):
        super().__init__(
            nf=96,
            ch_mult=(1, 1, 2, 2, 2, 2, 2),
...
if __name__ == "__main__":
    ...
    flops, params = get_model_complexity_info(
        mymodel, (1, 256, 256), as_strings=True,
