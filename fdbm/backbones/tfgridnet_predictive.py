...
class TFGridNet(AbsSeparator):
    ...
    def forward(self, y):
        ...
        out: [B, 1, F, T], complex
        """
        input = torch.cat((y.real, y.imag), dim=1)  # [B, 4, F, T]
...
@BackboneRegistry.register("tfgridnet_5l32c100_predictive")
class TFGridNet_5l32c100_predictive(TFGridNet):
...
if __name__ == "__main__":
    model = TFGridNet_5l32c100_predictive().eval()
    ...
    class Mymodel(TFGridNet_5l32c100_predictive):
        def __init__(self):
            super().__init__()
